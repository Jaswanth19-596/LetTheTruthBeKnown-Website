    ...
    <div className="st-page">
      ...
      <section className="st-hero">
        ...
        <div className="st-hero-content">
          ...
          <p className="st-hero-subtitle">
            Discover the most life-changing message in human history. We invite you to step away from the noise and watch these two essential messages to understand God's true plan of salvation.
          </p>
      ...
      <section className="st-videos-section st-reveal">
        <div className="st-section-header">
          ...
          <p className="st-videos-subtitle">Please watch these two powerful videos to explore salvation and witness faith in action around the world.</p>
        </div>
