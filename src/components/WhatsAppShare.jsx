      ...
      <div className="whatsapp-buttons">
        ...
        >
          {isGenerating ? 'Generating...' : (
            <>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="share-svg-icon" style={{ marginRight: '8px', verticalAlign: 'middle' }}>
